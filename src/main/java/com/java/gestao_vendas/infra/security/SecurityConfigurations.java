...
public class SecurityConfigurations {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/usuario/redefinir-senha").permitAll()
                        .requestMatchers(HttpMethod.POST, "/usuario/solicitar-redefinicao-senha").permitAll()
    ...
    public AuthenticationProvider authenticationProvider(UsuarioService usuarioService,
        ...
        return new CustomAuthenticationProvider(usuarioService, tentativaLoginService, passwordEncoder);
    }
